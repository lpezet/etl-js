...
ModClass.prototype._wrap_process = function( pStepId, pStep, pDataResults ) {
	var that = this;
	return function( pData ) { 
		...
		if ( pData['_exit'] ) {
			...
			try {
				return that._process( pStepId, pStep, pData, pDataResults );
			} catch (e) {
...
ModClass.prototype._process = function( pStepId, pStep, pPreviousStepData, pDataResults ) {
	var that = this;
