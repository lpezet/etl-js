			...
			try {
				...
				for ( var k in pConfig ) {
					...
					switch ( k ) {
						...
						case "server":
							oCmdArgs.push( "server=" + pConfig[k]);
							break;
						case "username":
							oCmdArgs.push( "username=" + pConfig[k]);
							break;
						case "password":
							oCmdArgs.push( "password=" + pConfig[k]);
							break;
						case "logicalname":
							oCmdArgs.push( "srcname=" + pConfig[k]);
							break;
						case "destinationip":
							oCmdArgs.push( "dstip=" + pConfig[k]);
							break;
						case "destinationpath":
							...
							break;
						case "destinationxml":
							oCmdArgs.push( "dstxml=" + pConfig[k]);
							break;
						case "maxconnections":
							oCmdArgs.push( "connect=" + pConfig[k]);
							break;
						case "timeout":
						...
						case "compress":
							...
							break;
						case "splitprefix":
							oCmdArgs.push( "splitprefix=" + pConfig[k]);
							break;
						default:
		...
		try {
			...
			for (var i in pConfig) {
				...
				if ( (! oDesprayConfig.destinationpath || ! oDesprayConfig.destinationip) && ! oDesprayConfig.destinationxml ) {
					...
					oPromises.push( that._despray( pParent, oLogicalFileName, oDesprayConfig, pExecutor, oTemplateContext ) );
				}
			}
