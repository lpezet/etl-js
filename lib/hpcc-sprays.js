			...
			for (var i in pConfig) {
				...
				if ( ! oSprayConfig.format ) {
					...
					switch ( oSprayConfig.format ) {
						case "delimited":
						case "csv":
							oPromises.push( that._spray_delimited( pParent, oLogicalFileName, oSprayConfig, pExecutor, pContext ) );
							break;
						case "fixed":
							oPromises.push( that._spray_fixed( pParent, oLogicalFileName, oSprayConfig, pExecutor, pContext) );
							break;
						case "xml":
							oPromises.push( that._spray_xml( pParent, oLogicalFileName, oSprayConfig, pExecutor, pContext ) );
							break;
						default:
